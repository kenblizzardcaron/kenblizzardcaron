...
const theme = merge(tailwind, {
  ...
  colors: {
    ...
    profileShadow: colors.yellow[5],
    secondary: colors.gray[8],
    shadow: colors.gray[1],
    text: colors.gray[9],
    toggleIcon: colors.gray[7],
    modes: {
      dark: {
        ...
        muted: colors.gray[8],
        primary: colors.yellow[2],
        profileShadow: colors.gray[6],
        secondary: colors.gray[5],
        shadow: colors.gray[9],
        text: colors.gray[1],
        toggleIcon: colors.yellow[3],
